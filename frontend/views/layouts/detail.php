...
<head>
    ...
    <script src="<?= \common\models\CommonHelper::getAssetUrl('/ueditor/ueditor.comment.js')?>" charset="utf-8"></script>
    <script src="<?= \common\models\CommonHelper::getAssetUrl('/ueditor/ueditor.all.js')?>" charset="utf-8"></script>
</head>
<body>
<header class="hd">
